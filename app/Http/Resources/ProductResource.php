...
class ProductResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'cost_price' => $user->isAdmin() ? $this->cost_price : 0.0,
            'cost_price_after_discount' => $user->isAdmin() ? $this->cost_price_after_discount : 0.0,
            'cost_price_discount_start' => $user->isAdmin() ? $this->cost_price_discount_start : 0.0,
            'cost_price_discount_end' => $user->isAdmin() ? $this->cost_price_discount_end : 0.0,
